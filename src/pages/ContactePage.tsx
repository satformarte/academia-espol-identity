            ...
            <div className="bg-card border-b border-border">
                <div className="container mx-auto px-4 max-w-[1400px] py-3">
                    <nav className="flex items-center gap-1.5 text-[11px] font-body font-semibold uppercase tracking-[0.06em] text-muted-foreground">
                        <Link to="/" className="hover:text-accent transition-colors duration-150">{c.breadcrumbHome}</Link>
                        <ChevronRight size={12} className="opacity-40" />
                        <span className="text-foreground">{c.breadcrumb}</span>
                    </nav>
                </div>
            </div>
                    ...
                    <div className="max-w-3xl mx-auto space-y-5">
                        ...
                        <div className="bg-card border border-border rounded-2xl p-5">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <p className="font-display font-bold text-sm text-foreground">{c.horariTitle}</p>
                            </div>
                            <div className="space-y-2.5">
                                {c.horari.map(({ dia, hora }) => (
